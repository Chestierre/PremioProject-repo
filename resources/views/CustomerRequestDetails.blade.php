...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Input Customer Details') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customer.customer.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" autocomplete="lastname">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email_address" type="text" class="form-control @error('email_address') is-invalid @enderror" name="email_address" autocomplete="email_address">
