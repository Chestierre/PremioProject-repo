        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <h2><b>Orders: {{$user->customer->FirstName}} {{$user->customer->LastName}}</b></h2>
                                ...
                                <form method="POST" action="{{ route('admin.order.store') }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" value="{{$user->customer->FirstName}} {{$user->customer->LastName}}"  disabled>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            // console.log($('#modal_unit_select').val());
            queryPrice(id);
        ...
        //http://127.0.0.1:8000/queryPrice/2
        //http://127.0.0.1:8000/admin/admincustomer/customerOrder/queryPrice/2 
