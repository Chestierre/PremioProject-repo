...
<body>
    ...
    <div class="row bg-primary d-flex justify-content-center">
        <div class="d-flex justify-content-center">
            <div class="h1">You are currently not Logged in!</div>
        </div>
        <div class="row d-flex justify-content-center mb-2">
            <div class="col-6 text-center">
                <div class="">Please log in to add it to your preorder list. if you don't have and account, You need to make/register an account and fillout the details. After this you will be granted a temporary account (Applicant). In this account you can preorder any order you wish to buy. In order to finalize your order you need to go to the premio store to buy the product.</div>
            </div>
        </div>
        <div class="d-flex justify-content-center mb-4">
            {{-- <a class="btn-danger" action={{url()->previous()}}>Go Back</a>
             --}}
    ...
    <div class="container">                  
        <div id="signupbox" class="mt-5 mainbox col-md-7 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <div class="panel-title">Application Form and Register Account</div>
                </div>  
                <div class="panel-body" >
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{route('registerguest')}}">
                        ...
                        @endif
                            ...
                            <div id="div_id_username" class="form-group required">
                                ...
                                <div class="controls col-md-8">
                                    <input class="input-md  textinput textInput form-control @error('username') is-invalid @enderror" id="id_username" maxlength="30" name="username" value="{{ old('username') }}" placeholder="Enter your username" style="margin-bottom: 10px" type="text" autofocus/>
                                    @error('username')
                            ...
                            <div id="div_id_password" class="form-group required">
                                ...
                                <div class="controls col-md-8">
                                    <input class="input-md  textinput textInput form-control @error('password') is-invalid @enderror" id="id_password" maxlength="30" name="password" value="{{ old('password') }}" placeholder="Enter your password" style="margin-bottom: 10px" type="password" />
                                    @error('password')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div id="div_id_password_confirmation" class="form-group required">
                                <label for="id_password_confirmation" class="control-label col-md-4  requiredField"> Confirm Password<span class="asteriskField">*</span> </label>
                                <div class="controls col-md-8">
                                    <input class="input-md  textinput textInput form-control" id="id_password_confirmation" maxlength="30" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Confirm password" style="margin-bottom: 50px" type="password" />
                                </div>
                            </div>
                            ...
                            <div id="div_id_FirstName" class="form-group required">
                                ...
                                <div class="controls col-md-8">
                                    <input class="input-md  textinput textInput form-control @error('FirstName') is-invalid @enderror" id="id_FirstName" maxlength="30" name="FirstName" value="{{ old('FirstName') }}" placeholder="Enter your first name" style="margin-bottom: 10px" type="text"  autocomplete="firstname"/>
                                    @error('FirstName')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div id="div_id_MobileNumber" class="form-group required">
                                ...
                                <div class="controls col-md-8">
                                    <input class="input-md  textinput textInput form-control @error('MobileNumber') is-invalid @enderror" id="id_MobileNumber" maxlength="30" name="MobileNumber" value="{{ old('MobileNumber') }}" placeholder="Enter your Mobile Number (+689)" style="margin-bottom: 10px" type="text" />
                                    @error('MobileNumber')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
